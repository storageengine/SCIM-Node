...
module.exports = function (params) {
   ...
   * rejected.
   */
  function retrieveUsers(userEndpoint, rpt, startIndex, count, filter) {
    var options = {
      method: 'GET',
      url: userEndpoint,
      qs: {},
  ...
  module.getUsers = function getUsers(startIndex, count, filter, callback) {
    return new Promise(function (resolve, reject) {
      ...
      return getRPTToken(params)
        .then(function (rptDetail) {
          userEndpoint = rptDetail.scimConfig.user_endpoint;
          return retrieveUsers(userEndpoint, rptDetail.RPT, startIndex, count, filter)
            .then(function (users) {
        ...
        .then(function (rpt) {
          return retrieveUsers(userEndpoint, rpt, startIndex, count, filter);
        })
        .then(function (users) {
          return resolve(users);
        })
   ...
   * @returns {requestCallback|Promise<object, error>} - callback or promise that returns user detail if resolved, or an Error if rejected.
   */
  module.updateUser = function(id, userData, callback) {
    return new Promise(function (resolve, reject) {
      var userEndpoint = '';
      return getRPTToken(params)
        .then(function (rptDetail) {
          userEndpoint = rptDetail.scimConfig.user_endpoint;
          return updateUser(userEndpoint, rptDetail.RPT, id, userData)
            .then(function (user) {
              return resolve(user);
            })
            .catch(function (error) {
        ...
        .then(function (rpt) {
          return updateUser(userEndpoint, rpt, id, userData);
        })
        .then(function (user) {
          return resolve(user);
        })
